...
$stmt = $pdo->prepare("SELECT * FROM statik_supportTickets WHERE status='Closed' ORDER BY status DESC, CASE priority WHEN 'High' THEN 3 WHEN 'Medium' THEN 2 WHEN 'Low' THEN 1 END DESC, id DESC");
$stmt->execute();
?>
    ...
    <div class="ui column">
        <div class="ui container">
            ...
            <h2 class="ui dividing header">Admin Control Panel - Closed Tickets</h2>
