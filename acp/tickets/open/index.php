...
?>
    ...
    <div class="ui column">
        <div class="ui container">
            ...
            <h2 class="ui dividing header">Admin Control Panel - Open Tickets</h2>
                    ...
                    while ($ticket = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        while ($reply = $stmtAnswered->fetch(PDO::FETCH_ASSOC)) {
                            if (isAdmin($reply["username"])) {
                                $status = "<span style='color:#27ae60;'>Answered</span>";
                            } else {
                                $status = "<span style='color:#d35400;'>Unanswered</span>";
                            }
                        }
                        ...
                        <td>" . ((isset($status)) ? $status : '<span style="color:#d35400;">Unanswered</span>') . "</td>
