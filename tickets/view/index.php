...
<div class="ui column">
    <div class="ui container">
        ...
        <div class="ui piled orange segment" id="ticketData" style="display: none">
            ...
            <div class="ui animated fade button small" onclick="window.location.replace('/tickets')">
            ...
            <?php if ($ticket['status'] === "Open"): ?>
                ...
                <div class="ui animated fade button red small" onclick="closeTicket()">
            ...
            <?php else: ?>
                <div class="ui animated fade button teal small" onclick="openTicket()">
                    <div class="visible content">Re-Open</div>
                    <div class="hidden content">
...
<script>
    ...
    function submitReply() {
        ...
        if (reply === "") {
            ...
            $.post("addReply.php", {ticketID: ticketID, username: user, reply: reply, token: token},
                function (data) {
                    if (data === "true") {
                        location.reload();
                    }
...
<script>
    function closeTicket() {
        var ticketID = "<?php echo $id ?>";
        var token = "<?php echo $_SESSION["token"] ?>";
        $.post("toggleStatus.php", {changeTo: "Closed", ticketID: ticketID, token: token},
            function (data) {
                console.log(data);
                if (data === "true") {
                    location.reload();
...
<script>
    function openTicket() {
        var ticketID = "<?php echo $id ?>";
        var token = "<?php echo $_SESSION["token"] ?>";
        $.post("toggleStatus.php", {changeTo: "Open", ticketID: ticketID, token: token},
            function (data) {
                console.log(data);
                if (data === "true") {
                    location.reload();
